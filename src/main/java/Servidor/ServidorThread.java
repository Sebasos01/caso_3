...
public class ServidorThread extends Concurrente {
    ...
    public ServidorThread(int modo, Socket socket, int id, String nombre) {
         ...
         */
        MODO = modo;
        LLAVE_PRIV_SERVIDOR = FNS_SEGURIDAD.obtenerLlavePrivadaServidor("datos_asim_srv.pri", MENSAJE_DEFECTO);
    }
    ...
    public void verificarInicilizacion() throws Exception {
        ...
        if (!inicializacionCliente.equals(INICIO_SEGURO)) {
            throw new RespuestaInvalidaException("mensaje de inicializacion invalido -> " + inicializacionCliente);
        }
    }
    ...
    private void invalidarFirmaIncorrecta(String datosPreLlave) throws Exception {
        ...
        String autenticacionErronea = byte2HexaStr(
                FNS_SEGURIDAD.firmarConCifradoAsimetrico(llavePrivadaErronea, datosPreLlave));
        ...
        if (respuestaCliente.equals(MENSAJE_ERROR)) {
            ...
            throw new RespuestaInvalidaException(
                    "==========> Prueba 0: fallida (el cliente valida una firma equivocada)");
        } else {
            throw new RespuestaInvalidaException(
                    "==========> Prueba 0: fallida (el cliente ha retornado un valor invalido) -> " + respuestaCliente);
        }
    }
    ...
    private void validarFirmaCorrecta(String datosPreLlave) throws Exception {
        ...
        if (respuestaCliente.equals("OK")) {
            ...
            throw new RespuestaInvalidaException(
                    "==========> Prueba 1a: fallida (el cliente invalida una firma correcta)");
        } else {
            throw new RespuestaInvalidaException(
                    "==========> Prueba 1a: fallida desastrosamente (el cliente ha retornado un valor invalido) -> " + respuestaCliente);
        }
    }
    ...
    private Pair<Boolean, String> recibirYVerificarIntegridadConsulta() throws Exception {
        ...
        byte[] consultaDescifrada = FNS_SEGURIDAD.desencriptadoSimetrico(consultaCifrada, llaveCifrado,
    ...
    private String manejarConsulta() throws Exception {
        ...
        if (!hayIntegridad.p) {
            ...
            imprimirInfo(
                    "respuesta de verificacion de integridad de la consulta enviada al cliente -> " + MENSAJE_ERROR);
            throw new RespuestaInvalidaException(
                    "==========> error inesperado en la prueba1, no hay integridad en la consulta recibida por parte del cliente");
        }
        canalEscritura.println(MENSAJE_OK);
        imprimirInfo("respuesta de verificacion de integridad de la consulta enviada al cliente -> " + MENSAJE_OK);
    ...
    private void verificarRespuestaSinIntegridad() throws Exception {
        ...
        if (verificacionCliente.equals(MENSAJE_ERROR)) {
            ...
            throw new RespuestaInvalidaException(
                    "==========> Prueba 1b: fallida (el cliente acepta una respuesta sin integridad)");
        } else {
            throw new RespuestaInvalidaException(
                    "==========> Prueba 1b: fallida desastrosamente, respuesta invalida -> " + verificacionCliente);
        }
    }
    ...
    private void verificarRespuestaConIntegridad() throws Exception {
        ...
        if (verificacionCliente.equals(MENSAJE_OK)) {
            ...
            throw new RespuestaInvalidaException(
                    "==========> Prueba 1b: fallida (el cliente rechaza una respuesta con integridad)");
        } else {
            throw new RespuestaInvalidaException(
                    "==========> Prueba 1b: fallida desastrosamente, respuesta invalida -> " + verificacionCliente);
        }
    ...
    private void enviarRespuestaConIntegridad(String consulta) throws Exception {
        ...
        String respuestaCompleta = String.format("%s;%s;%s", respuestaCifrada, codigoIntegridad, vectorInicializacion);
    ...
    private void enviarRespuestaSinIntegridad(String consulta) throws Exception {
        ...
        byte[] respuestaModificadaCifradaBytes = FNS_SEGURIDAD.encriptadoSimetrico(respuestaModificadaBytes,
                llaveCifrado, hexaStr2Iv(vectorInicializacion), String.valueOf(ID));
        ...
        String respuestaCompleta = String.format("%s;%s;%s", respuestaModificadaCifrada, codigoIntegridadCorrecto,
