...
public class ClienteThread extends Concurrente {
    ...
    public ClienteThread(Socket socket, int id, String nombre) {
        ...
        LLAVE_PUB_SERVIDOR = FNS_SEGURIDAD.
                obtenerLlavePublicaServidor("datos_asim_srv.pub", MENSAJE_DEFECTO);
    }
    ...
    public void validarFirma(String firma, String gpy) throws Exception {
        ...
        if (laFirmaEsVeridica) {
            ...
            throw new RespuestaInvalidaException("la firma no es valida, la conexion no es segura -> cerrando conexion...");
        }
    }
    ...
    public void enviarConsultaConIntegridad() throws Exception {
        ...
        String consultaCifrada = byte2HexaStr(FNS_SEGURIDAD.encriptadoSimetrico(consulta, llaveCifrado,
        ...
        String consultaCompleta = String.format("%s;%s;%s", consultaCifrada,
    ...
    public void validarRespuestaIntegridadConsultaServidor() throws Exception {
        ...
        if (respuestaIntegridad.equals(MENSAJE_ERROR)) {
            throw new RespuestaInvalidaException("el servidor no pudo validar la integridad de la consulta enviada, cerrando conexion...");
        }
    }
    ...
    private Pair < Boolean, String > verificarIntegridadRespuestaServidor() throws Exception {
        ...
        byte[] respuestaDescifrada = FNS_SEGURIDAD.desencriptadoSimetrico(respuestaCifrada,
    ...
    private void manejarRespuestaConsulta() throws Exception {
        ...
        if (!verificacion.p) {
            canalEscritura.println(MENSAJE_ERROR);
            imprimirInfo("respuesta de verificaicon de integridad a la respuesta de la consulta enviada al servidor -> " +
                    MENSAJE_ERROR);
            throw new RespuestaInvalidaException("no hay integridad en la respuesta de la consulta, conexion insegura, cerrando conexion...");
        }
        canalEscritura.println(MENSAJE_OK);
        imprimirInfo("respuesta de verificaicon de integridad a la respuesta de la consulta enviada al servidor -> " +
                MENSAJE_OK);
